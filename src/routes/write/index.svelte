...
<main>
    <DatabaseHeader>
        ...
        {:else}
            <a href="https://discord.com/api/oauth2/authorize?client_id=895468421054083112&redirect_uri=http%3A%2F%2F45.32.217.67%2Fauth%2Fwrite&response_type=code&scope=identify">
